...
public class CsvFormatterTest {
    ...
    public void formatSeveralRowsOfDataIntoHeaderAndDataRows() throws Exception {
        ...
        String headderRow = rowsArray[0];
        assertThat(headderRow).isEqualTo("string,long");
    ...
    private List<Map<String, Object>> givenARowOfDataFromQueriesTable(Map<String, Object> ... oneRowOfDataAsMap) {
